...
it("renders correctly", () => {
  ...
  expect(asFragment()).toMatchInlineSnapshot(`
    ...
    .c0 .vegan:nth-child(1) {
      background: #FFFFFF;
      box-shadow: 0 2px 0 2px #BDC2C4;
    }

    .c0 .vegan:nth-child(2) {
      left: 0;
      top: -3px;
    ...
    .c0 .vegan:nth-child(3):before,
    .c0 .vegan:nth-child(3):after {
      content: "";
      position: absolute;
      background: #ef8927;
      border-radius: 20px;
    ...
    .c1:checked + label .vegans {
      -webkit-transform: translateX(34px);
      -ms-transform: translateX(34px);
      transform: translateX(34px);
    }

    .c1:checked + label .vegan:nth-child(1) {
      background: #e27c31;
      box-shadow: 0 2px 0 2px #fbbe7c;
    ...
    .c1:checked + label .vegan:nth-child(2) {
    ...
    .c1:checked + label .vegan:nth-child(3) {
      -webkit-transform: scale(1);
      -ms-transform: scale(1);
      transform: scale(1);
